...
//		System.setProperty("webdriver.gecko.driver", "C:\\Users\\fatim\\Downloads\\geckodriver-v0.33.0-win-aarch64\\geckodriver.exe");
//		WebDriver driver = new FirefoxDriver();
		...
		driver.findElement(By.xpath("//*[text()='Log Out']")).click(); //* means any anchor all anchors
		driver.close();
